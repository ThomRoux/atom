  ...
  updateBlockDecorations () {
    ...
    for (const lineId of Object.keys(this.newTileState.lines)) {
      ...
      for (const decorationId of Object.keys(newLineState.precedingBlockDecorations)) {
        const blockDecoration = newLineState.precedingBlockDecorations[decorationId]
        if (oldLineState.precedingBlockDecorations.hasOwnProperty(decorationId)) {
          const {topRulerNode, blockDecorationNode, bottomRulerNode} =
            this.blockDecorationNodesByLineIdAndDecorationId[lineId][decorationId]
          bottomRulerNode.dataset.screenRow = newLineState.screenRow
          blockDecorationNode.dataset.screenRow = newLineState.screenRow
          topRulerNode.dataset.screenRow = newLineState.screenRow
        } else {
          const topRulerNode = document.createElement('div')
          topRulerNode.dataset.screenRow = newLineState.screenRow
          this.domNode.insertBefore(topRulerNode, lineNode)
          const blockDecorationNode = this.views.getView(blockDecoration.getProperties().item)
          blockDecorationNode.dataset.screenRow = newLineState.screenRow
          ...
          oldLineState.precedingBlockDecorations[decorationId] = newLineState.precedingBlockDecorations[decorationId]
        }
      }
      for (const decorationId of Object.keys(newLineState.followingBlockDecorations)) {
        const blockDecoration = newLineState.followingBlockDecorations[decorationId]
        if (oldLineState.followingBlockDecorations.hasOwnProperty(decorationId)) {
          const {topRulerNode, blockDecorationNode, bottomRulerNode} =
            this.blockDecorationNodesByLineIdAndDecorationId[lineId][decorationId]
          bottomRulerNode.dataset.screenRow = newLineState.screenRow
          blockDecorationNode.dataset.screenRow = newLineState.screenRow
          ...
          this.blockDecorationNodesByLineIdAndDecorationId[lineId][decorationId] =
            {topRulerNode, blockDecorationNode, bottomRulerNode}
          oldLineState.followingBlockDecorations[decorationId] = newLineState.followingBlockDecorations[decorationId]
        }
      }
    }
  }
